<template>
  <div class="home">
    ...
    <div class="card-wrapper" v-else-if="this.forecast.cod">
      <p class="text-capitalize blockquote">
        {{this.errors}} or Wrong Format
        <br />
        <span class="subtitle-1">Try searching in this format (City, country)</span>
      </p>
    </div>
  </div>
</template>
